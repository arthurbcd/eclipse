...
public class CountPair {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length < 1) {
            System.out.println("Uso: CountPair <porta>");
            return;
        }
        // Dans le protocole Count, le serveur repond a ninporte quelle requete du client par
        // un paquet contenant un long un long en BigEndien qui donne le nombre de paquests recus de ce client contenant un long pair suivi dun long en LittleEndian qui donne le nombre de paquets avec les memems proprietes total reçus
